...
BeadDict = {'P5': 'P5', 'C1' : 'C1', 'C2' : 'SC3', 'C3' : 'SC3', 'C4' : 'SC3', 'Na': 'Na', 'SC1' : 'SP1', 'SC2' : 'SP1', 'SC3' : 'SP1'} # Dict to store name and type of the MARTINI beads used for making the CG NP

BeadMass = {'P5' : 30.0, 'C1' : 30.0, 'C2' : 30.0, 'C3' : 30.0, 'C4' : 30.0, 'Na': 30.0 , 'SC1' : 30.0, 'SC2' : 30.0, 'SC3' : 30.0} # Dict to store name and mass of the MARTINI beads used for making the CG NP 
...
for res in PETAtoms.residues:
	...
	#	print (ligandsResIDS)
	print (ligandResIDS[0], ligandResIDS[1], 1, 0.2000, 392459.2) #  ST - C1  
...
for res in SAtoms.residues:
	...
	ligandResIDS = res.atoms.ids 
	#	print (ligandsResIDS)
	print (ligandResIDS[0], ligandResIDS[1], 1, 0.2000, 392459.2) # ST - RA 
